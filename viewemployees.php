...
if(isset($_GET["empid"]))
{
$results = mysqli_query($db,"DELETE from employee where employeeid ='$_GET[empid]'");
}
$results= mysqli_query($db,"select * from employee where employeetype='Employees'");
...
else
{
	?>
		<form id="form1" name="form1" method="post" action="">
          ...
          <?php
		  while($arrrec = mysqli_fetch_array($results))
		  {  
		   echo" <tr>
