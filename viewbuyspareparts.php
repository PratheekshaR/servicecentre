...
{
$dt= date("Y-m-d");
mysqli_query($db,"UPDATE sparepartsorder SET status='Delivered',deliverydate='$dt' where sporderid='$_GET[ordid]'");
}

if(isset($_SESSION["custid"]))
{
	$result= mysqli_query($db,"select * from sparepartsorder where custid='$_SESSION[custid]'");
}
else
{
...
$result3= mysqli_query(db,"select * from customer where custid='$arrrec[custid]'");
